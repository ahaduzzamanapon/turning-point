...
export default function Settings({ auth, settings }) {
    ...
    return (
        <AuthenticatedLayout
            user={auth.user}
            header={<h2 className="font-semibold text-xl text-light-800 leading-tight">Settings</h2>}
        >
            <Head title="Settings" />
                    ...
                    <div className="bg-black/30 backdrop-blur-xl shadow-lg rounded-lg border border-white/10 p-6">
                        <div className="p-6 text-gray-900">
                            ...
                            <form onSubmit={handleSubmit}>
                                ...
                                <div className="mb-4">
                                    <label htmlFor="sidebar_color" className="block text-sm font-medium text-gray-700">Sidebar Color</label>
                                    <input
                                        type="color"
                                        id="sidebar_color"
                                ...
                                <div className="mb-4">
                                    <label htmlFor="sidebar_text_color" className="block text-sm font-medium text-gray-700">Sidebar Text Color</label>
                                    <input
                                        type="color"
                                ...
                                <div className="mb-4">
                                    <label htmlFor="admin_header_color" className="block text-sm font-medium text-gray-700">Admin Header Color</label>
                                    <input
                                        type="color"
                                ...
                                <div className="mb-4">
                                    <label htmlFor="admin_header_text_color" className="block text-sm font-medium text-gray-700">Admin Header Text Color</label>
                                    <input
                                        type="color"
                                ...
                                <div className="mb-4">
                                    <label htmlFor="logo" className="block text-sm font-medium text-gray-700">App Logo</label>
                                    <input
                                        type="file"
                                        id="logo"
